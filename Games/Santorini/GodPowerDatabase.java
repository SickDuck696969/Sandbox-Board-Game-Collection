...
public class GodPowerDatabase {
    ...
    public static List<GodPower> getGods() {
        ...
        gods.add(new GodPower(
            "OMNI-MAN", 
            "Your Move", 
            "Place your Workers first. Your Workers must be placed in perimeter spaces. If your Worker moves into a space and the next space in the same direction is occupied by an opponent Worker, the opponent's Worker is removed from the game.", 
        ...
        gods.add(new GodPower(
            "OPTIMUS PRIME", 
            "Opponent's Turn", 
            "Opponent cannot win by moving into a perimeter space.", 
        ...
        // 21. Noob Saibot (Mortal Kombat) - Dựa trên Terpsichore
        gods.add(new GodPower(
            "NOOB SAIBOT", 
            "Your Turn", 
            "All of your workers must move, and then all must build.", 
            "images/Santorini/NoobSaibot.png"
        ));
        ...
        // 25. Godzilla - Dựa trên Asteria (Hơi thở nguyên tử từ xa)
        gods.add(new GodPower(
            "GODZILLA", 
            "End of Your Turn", 
            "If one of your Workers moved down this turn, you may build a dome on any unoccupied space.", 
            "images/Santorini/Godzilla.png"
        ));

        // 26. Xenomorph (Alien) - Dựa trên Theseus (Sát thủ rình rập trên cao)
        gods.add(new GodPower(
            "XENOMORPH", 
            "End of Your Turn", 
            "Once, if any opponent's Worker is exactly 2 levels lower than your neighboring Worker, it is removed from the game.", 
            "images/Santorini/Xenomorph.png"
        ));

        // 27. Megaman X - Dựa trên Bellerophon (Bám tường / Wall-Jump)
        gods.add(new GodPower(
            "X", 
            "Your Move", 
            "Once, if your Worker moves up, it may move up two levels.", 
            "images/Santorini/MegamanX.png"
        ));
        // 28. Pain (Naruto) - Dựa trên Harpies (Thần La Thiên Chinh / Sóng Xung Kích)
        // Cập nhật: Đẩy lùi đối thủ liên tục mỗi khi di chuyển.
        gods.add(new GodPower(
            "PAIN", 
            "Opponent's Turn", 
            ...
            "images/Santorini/Pain.png"
        ));
        // 29. Kitasan Black (Uma Musume) - Dựa trên Urania (Tốc độ bức tốc xuyên bản đồ)
        gods.add(new GodPower(
            "KITASAN BLACK", 
            "Your Turn", 
            "Your Worker may move or build across the board to the unoccupied space on the opposite edge.", 
            "images/Santorini/KitasanBlack.png"
        ));

        // 30. Tearlaments Rulkallos - Dựa trên Limus (Negate / Cấm xây dựng)
        gods.add(new GodPower(
            "TEARLAMENTS RULKALLOS", 
            "Opponent's Turn", 
            "Opponent Workers cannot build on spaces neighboring your Workers, unless building a dome.", 
            "images/Santorini/Rulkallos.png"
        ));

        // 31. Iori Yagami - Dựa trên Iris (Cross-up / Đánh vòng ra sau lưng)
        gods.add(new GodPower(
            "IORI YAGAMI", 
            "Your Move", 
            "If there is a Worker neighboring your Worker and the space directly on the other side of it is unoccupied, your worker may move to that space regardless of its level.", 
            "images/Santorini/Iori.png"
        ));

        // 32. Alucard (Castlevania) - Dựa trên Eris (Thôi miên thao túng đối thủ)
        gods.add(new GodPower(
            "ALUCARD", 
            "Your Turn", 
            "You may move and build with an opponent’s Worker this turn instead of your own, as long as it is not their worker that they most recently moved.", 
            "images/Santorini/Alucard.png"
        ));
        // 33. Aizen Sousuke (Bleach) - Dựa trên Persephone (Hóa thân / Thay đổi quyền năng)
        gods.add(new GodPower(
            "AIZEN SOUSUKE", 
            "Opponent's Turn", 
            "If possible, at least one Worker must move up this turn.", 
            "images/Santorini/Aizen.png"
        ));
        // 34. Light Yagami - Dựa trên Dionysus (Hóa thân / Thay đổi quyền năng)
        gods.add(new GodPower(
            "LIGHT YAGAMI", 
            "Your Build", 
            ...
            "images/Santorini/Light.png"
        ));
        // 35. Mario & Luigi - Dựa trên Castor & Pollux (Hợp thể / Đồng hành)
        gods.add(new GodPower(
            "MARIO & LUIGI", 
            "Your Turn", 
            "Instead of your normal turn, you may take a special turn in which all your Workers move and you do not build, or in which none of your Workers move, but all build.", 
            "images/Santorini/Mario.png"
        ));
        // 36. Kuroyukihime (Accel World) - Dựa trên Achilles
        gods.add(new GodPower(
            "KUROYUKIHIME", 
            "Your Turn", 
            "Once, your Worker builds both before and after moving.", 
            "images/Santorini/KYH.png"
        ));
        //Chrollo Lucilfer (Hunter x Hunter) - Dựa trên Circe
        gods.add(new GodPower(
            "CHROLLO LUCILFER", 
            "Start of Your Turn", 
            "If opponent’s Workers do not neighbor each other, you alone have use of their power until your next turn.", 
            "images/Santorini/Chrollo.png"
        ));
        //BoBoiBoy - Dựa trên Gaea
        gods.add(new GodPower(
            "BOBOIBOY", 
            "Any Move", 
            "Twice, when a Worker builds a dome, you may immediately place a Worker onto a ground-level space neighbouring the dome.", 
            "images/Santorini/BBB.png"
